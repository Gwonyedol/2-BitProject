	...
	<div class="wizard-header">
		<ul class="nav nav-pills">
			<li class="nav-item"><a href="#tab1" data-toggle="tab"
				class="nav-link active">1. STEAM GAME</a></li>
			<li class="nav-item"><a href="#tab2" data-toggle="tab"
				class="nav-link">2. POSITIVE RANK</a></li>
			<li class="nav-item"><a href="#tab3" data-toggle="tab"
				class="nav-link">3. PLAYTIME RANK</a></li>
		</ul>
	</div>
	<!-- END wizard-header -->
	<!-- BEGIN wizard-form -->
	<form action="#" method="POST" name="wizard_form">
		...
		<div class="wizard-content tab-content">
			...
			<div class="wizard-footer">
				<a href="#"
					class="btn btn-white wizard-prev-btn btn-rounded mr-auto">Previous</a>
				<a href="#"
					class="btn btn-primary wizard-next-btn btn-rounded ml-auto">Next</a>
			</div>
			<!-- END wizard-footer -->
		</div>
		<!-- END wizard-content -->
