...
<!-- 콘텐츠 영역 시작-->
<form name="qawrite" action="videoeditok.vb" method="POST">
	...
	<div class="row">
		...
		<div class="col-10">
			<div class="form-group">
			  <input type="text" class="form-control" id="title" name="title" placeholder="글 제목을 입력해 주세요">
			</div>
		</div>
		<div class="col-1"></div>
	</div>
	...
	<div class="row" id="write-button">	
		<div class="col-1"></div>
		<div class="col-5">
			<div class="text-left"><button type="button" onclick="location.href='video.vb'" class="btn btn-secondary" id="cancel-btn">취소</button></div>
		</div>
		<div class="col-5">
			<div class="text-right"><button type="submit" class="btn btn-primary" id="enter-btn">수정</button></div>
		</div>
		<div class="col-1"></div>
	</div>
</form>
