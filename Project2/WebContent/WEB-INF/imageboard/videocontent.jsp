...
<div class="row" id="write-button">
	<div class="col-5">
		<div class="text-left">
			<button type="button" onclick="location.href='videoedit.vb'"
				class="btn btn-secondary" id="cancel-btn">삭제</button>
		</div>
	</div>
	<div class="col-7">
		<div class="text-right">
			<button type="submit" onclick="location.href='videoedit.vb'"
				class="btn btn-primary" id="enter-btn">수정</button>
		</div>
	</div>
	<div class="col-1"></div>
</div>
