...
<%-- <div id="columns">	
   	<c:forEach var="i" begin="1" end="5" escapeXml="false" >       
		...
		<figure>	
			<img src="./resource/img/gameimage4.jpg">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure>
		
		<figure>	
			<img src="./resource/img/gameimage5.jfif">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure> 
		
		<figure>	
			<img src="./resource/img/gameimage6.jfif">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure> 
				
		<figure>	
			<img src="./resource/img/gameimage7.jpg">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure> 
		
		<figure>	
			<img src="./resource/img/gameimage8.jpg">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure>
				
		<figure>	
			<img src="./resource/img/gameimage9.jfif">
			<figcaption><b>제목</b><br>작성자</figcaption>
		</figure>
