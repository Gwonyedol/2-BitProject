...
<script 
	src="${pageContext.request.contextPath}/resource/js/tipboard.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/resource/js/tipboard-ajax.js"
	type="text/javascript"></script>
...
<c:set var="board" value="${requestScope.board}" /> <!-- ..result -->
		...
		<div class="text-left">
			<h5>
				<i class="fas fa-lg fa-fw m-r-10 fa-info"></i> <span
					class="text-inverse"><B>Play of the Tip</B></span>
			</h5>
		</div>
	</div>
	...
	<div class="col-12">
			...
			<div class="card ">
				<div class="card-header card-header-inverse">
					<div class="col-12">
						<h5>${requestScope.board.title}</h5>
					</div>
				</div>
			</div>
...
<!-- @@@@@@@@@@@@@@@@@@@@@ reply Start @@@@@@@@@@@@@@@@@@@@ -->
	...
	<div class="card-header card-header-inverse">
		<div class="card-body text-dark">
			<div style="color: white" id="reply_paste">
				<div class="row">
					<div class="col-11">
					<h3>&nbsp;Comment ${requestScope.board.count}</h3> <!-- Comment -->				
				</div>
				<div class="col-0">
					<H3>${nick_name}</H3>
				</div>
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<dl class="reply-write">
									<dd>
										<textarea name="editor1" id="editor1"
											placeholder="로그인을 하면 댓글 작성이 가능합니다" title="댓글 내용 이력" readonly></textarea>
									</dd>
								</dl>
								<button type="submit" class="reply-btn" id="enterbtn">
									Comment Send</button>
