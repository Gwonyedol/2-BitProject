...
<!-- 콘텐츠 영역 시작-->
	<div class="row">
		<div class="col-6">
			<div class="text-left">
				<h3><i class="fab fa-steam"></i>&nbsp;STEAM Q&A</h3>
			</div>
		</div>
		<div class="col-6">	
	...
	<div class="row">
		<div class="col-1"></div>
   		<div class="col-9" id='reply_paste'>	
   			<div class="card">
   				<div class="card-header">총&nbsp;<div class="text-primary">${requestScope.result.count}</div>개의 답변이 있습니다</div>
			</div> 			 
				...
				<div class="card">
					<div class="row no-gutters" id='qa_no_gutters'>
					    ...
					    <div class='col-10' id='qa_detail_reply_div_content'>
					    	<div class='text-left'>&nbsp;<i class="far fa-user"></i> ${qa.r_nick_name}</div>
					...
					<div id='qa_boarder'></div>
					<div class='row'>
						<div class="card-body text-dark">${qa.reply_content}</div>
					</div>
				</div>
...
<!-- 					<textarea name="editor1" id="editor1" style="display:none;"></textarea>
					<div class="text-right" style="display:none;">
						<button type="submit" class="btn btn-secondary disabled" id="enterbtn" style="display:none;">답변 등록</button>
					</div>  -->
				</c:otherwise>	
			</c:choose>
   		</div>
